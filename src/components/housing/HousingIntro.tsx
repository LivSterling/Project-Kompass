...
export default function HousingIntro({ blok }: HousingIntroProps) {
  const label = blok.button_label || "Submit a Referral";
  const href =
    ...
    >
      <div className="section-shell px-4 md:px-6">
        ...
        <div className="mt-10 flex justify-center md:mt-12">
          <a
            href={href}
            className="font-heading inline-flex h-[51px] w-[222px] items-center justify-center bg-green px-5 py-[10px] text-center text-[20px] leading-[28px] tracking-[0.01em] text-black transition hover:brightness-105"
          >
            {label}
          </a>
        </div>
